...
class Site(NamedObject):
    ...
    short_name: str|None = Field(default=None, description="Common or short name of the Site.", example="ALCF")
    operating_organization: str|None = Field(..., description="Organization operating the Site.", example="Argonne Leadership Computing Facility")
    country_name: str|None = Field(default=None, description="Country name of the Location.", example="United States")
    locality_name: str|None = Field(default=None, description="City or locality name of the Location.", example="Lemont")
    state_or_province_name: str|None = Field(default=None, description="State or province name of the Location.", example="Illinois")
    street_address: str|None = Field(default=None, description="Street address of the Location.", example="9700 South Cass Avenue")
    unlocode: str|None = Field(default=None, description="United Nations trade and transport location code.", example="US")
    altitude: float|None = Field(default=None, description="Altitude of the Location.", example=1.0)
    latitude: float|None = Field(default=None, description="Latitude of the Location.", example=11.0)
    longitude: float|None = Field(default=None, description="Longitude of the Location.", example=-111.0)
...
class Facility(NamedObject):
    ...
    short_name: str|None = Field(default=None, description="Common or short name of the Facility.", example="ALCF")
    organization_name: str|None = Field(default=None, description="Operating organization's name.", example="Argonne Leadership Computing Facility")
    support_uri: HttpUrl|None = Field(default=None, description="Link to facility support portal.", example="https://www.alcf.anl.gov/")
