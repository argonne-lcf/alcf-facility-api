...
class NamedObject(IRIBaseModel):
    ...
    name: str|None = Field(default=None, description="The long name of the object.", example="Object name")
    description: str|None = Field(default=None, description="Human-readable description of the object.", example="Description of the object")
